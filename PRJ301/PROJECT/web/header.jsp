        ...
        <header class="bg-gray-800 shadow-md text-gray-300">
            <nav class="container mx-auto px-6 py-3 flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-4 justify-center flex-grow mr-20">
                    ...
                    <div id="dropBrandsHover" class="z-10 hidden bg-gray-700 rounded-lg shadow w-44">
                        <ul class="py-2 text-sm text-gray-200" aria-labelledby="dropdownHoverButton">
                            <c:set var="brands" value="${requestScope.data.get(0).getListBrand()}"/>
                            <c:forEach var="brand" items="${brands}">
                                <li>
                    ...
                    <div id="dropdownHover" class="z-10 hidden bg-gray-700 rounded-lg shadow w-44">
                        <ul class="py-2 text-sm text-gray-200" aria-labelledby="dropdownHoverButton">
                            <c:set var="cates" value="${requestScope.data.get(0).getListCategory()}"/>
                            <c:forEach var="cate" items="${cates}">
                                <li>
                ...
                <div class="flex items-center space-x-4 ml-auto mr-10">
                    ...
                    <c:if test="${sessionScope.account == null}">
                        ...
                        <button id="dropdownUserAvatarButton" data-dropdown-toggle="dropdownAvatar" class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-600" type="button">
                            <i class="fas fa-user text-cyan-300 hover:text-white"></i>
                        </button>
                        <div id="dropdownAvatar" class="z-10 hidden bg-gray-700 rounded-lg shadow w-44">
                            <div class="px-4 py-3 text-sm text-white">
                                <div>Not Logged In</div>
                            </div>
                            <ul class="py-2 text-sm text-gray-200" aria-labelledby="dropdownUserAvatarButton">
                                <li>
                                    <a href="login" class="block px-4 py-2 hover:bg-gray-600 hover:text-white">Login</a>
                                </li>
                                <li>
                                    <a href="register" class="block px-4 py-2 hover:bg-gray-600 hover:text-white">Register</a>
                                </li>
                            </ul>
                        </div>
                        <!------------------------------------------------------------------------------------>
                    ...
                    <c:if test="${sessionScope.account != null}">
                        ...
                        <c:if test="${acc.getRole().equals('admin')}">
                            ...
                            <div id="dropdownAvatar" class="z-10 hidden bg-gray-700 rounded-lg shadow w-44">
                                ...
                                <ul class="py-2 text-sm text-gray-200" aria-labelledby="dropdownUserAvatarButton">
                                    <li>
                                        <a href="admin.jsp" class="block px-4 py-2 hover:bg-gray-600 hover:text-white">Dashboard</a>
                                    </li>
                                    <li>
                                        <form action="profile" method="post">
                                            <button type="submit" class="text-left w-full block px-4 py-2 hover:bg-gray-600 hover:text-white">Setting</button>
                                            <input type="hidden" value="${acc.id}" name="id"/>
                                        </form>
                                    </li>
                                </ul>
                                <div class="py-2">
                                    <a href="logout" class="block px-4 py-2 text-sm text-gray-200 hover:bg-gray-600 hover:text-white">Logout</a>
                                </div>
                            </div>
                            <!------------------------------------------------------------------------------------>
                        </c:if>
                        <c:if test="${!acc.getRole().equals('admin')}">
                            ...
                            <div id="dropdownAvatar" class="z-10 hidden bg-gray-700 rounded-lg shadow w-44">
                                ...
                                <ul class="py-2 text-sm text-gray-200" aria-labelledby="dropdownUserAvatarButton">
                                    <li>
                                        <form action="profile" method="post">
                                            <button type="submit" class="text-left w-full block px-4 py-2 hover:bg-gray-600 hover:text-white">Profile</button>
                                            <input type="hidden" value="${acc.id}" name="id"/>
                                        </form>
                                    </li>
                                </ul>
