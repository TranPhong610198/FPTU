<%-- 
    Document   : CategoryCRUD
    Created on : Oct 18, 2024, 5:01:45 PM
    Author     : tphon
--%>
...
<html>
    ...
    <body class="bg-gray-900 text-gray-300">
                            ...
                            <ul id="dropdown-crud" class="space-y-2 py-2 hidden">
                                ...
                                <li>
                                    ...
                                    <a href="listCategories" 
                                       class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 bg-gray-100 dark:bg-gray-700">Categories</a>
                                </li>
                                <li>
                                    <!--brand-->
                                    <a href="listBrand" 
        ...
        <script type="text/javascript">
            ...
            function openDeleteDrawer(categoryId) {
                document.getElementById('delete-link').href = 'deleteCategory?id=' + categoryId;
            }
