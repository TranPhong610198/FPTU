<%-- 
    Document   : ramCRUD
    Created on : Nov 4, 2024, 10:53:53 PM
    Author     : tphon
--%>
...
<html>
    ...
    <body class="bg-gray-900 text-gray-300">
        <div class="flex">
                        ...
                        <li class="mb-2">
                            ...
                            <ul id="dropdown-crud" class="space-y-2 py-2 hidden">
                                ...
                                <li>
                                    <!--ram-->
                                    <a href="listRam" 
                                       class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 bg-gray-100 dark:bg-gray-700">Ram</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <main class="flex-1 p-6">
                <div class="flex justify-between items-center mb-6">
                    <div class="text-2xl font-bold text-white">All Rams</div>
        ...
        <div id="drawer-create-product-default" class="fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
            <h5 id="drawer-label" class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">New Ram Option</h5>
            ...
            <form action="addRam" method="POST">
                <div class="space-y-4 ">
                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                        <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type ram size <number>GB" required="">
                    </div>
        ...
        <div id="drawer-update-product-default" class="fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
            ...
            <form action="updateRam" method="post">
        ...
        <script type="text/javascript">
            ...
            function openDeleteDrawer(ramId) {
                document.getElementById('delete-link').href = 'deleteRam?id=' + ramId;
            }
