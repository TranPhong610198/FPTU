...
//===========================================================================
  ...
  void insert(String xName, int xPrice)
     {//You should insert here statements to complete this function
      if(xName.charAt(0) == 'D' || xPrice<10000) return;
  ...
  void preOrder2(Node p, RandomAccessFile f) throws Exception
   ...
   void breadth2(Node p, RandomAccessFile f) throws Exception
    {if(p==null) return;
     ...
     while(!q.isEmpty())
       {r = q.dequeue();
        if(r.info.price > 30000 && r.info.price <= 50000) fvisit(r,f);
        if(r.left!=null) q.enqueue(r.left);
        if(r.right!=null) q.enqueue(r.right);
       }
    }
  ...
  void breadth3(Node p)
    {if(p==null) return;
     ...
     while(!q.isEmpty())
       {r = q.dequeue();
        if(r.left!=null && r.right!=null && r.info.price > 70000) {q123=r;break;};
        if(r.left!=null) q.enqueue(r.left);
        if(r.right!=null) q.enqueue(r.right);
       }
    }
  ...
  Node p123=null;
  void breadth4(Node p)
    {if(p==null) return;
     Queue q = new Queue();
     q.enqueue(p);Node r;
     while(!q.isEmpty())
       {r = q.dequeue();
        if(r.left!=null && r.info.price < 70000) {p123=r;break;};
        if(r.left!=null) q.enqueue(r.left);
        if(r.right!=null) q.enqueue(r.right);
       }
    }
