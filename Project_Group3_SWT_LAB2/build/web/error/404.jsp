<%-- 
    Document   : 404
    Created on : Feb 13, 2025, 3:55:05 PM
    Author     : VuxD4t
--%>
...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            #bumps{
                animation: land 5000ms linear infinite;
            }
            ...
            @keyframes cloud001 {
                0% {
                    transform: translateX(-500px) translateY(3px);
                }
                100% {
    ...
    <body>
        <div class="main">
            <div>
                ...
                <g id="ocean">
                <path id="sky" class="st0" d="M0 0h500v203.1H0z"/>
                ...
                <path id="water" fill="url(#water_1_)" d="M0 200.7h500V354H0z"/>
                <path id="land" class="st0" d="M0 273.4h500V354H0z"/>
                <g id="bumps">
                ...
                <path class="st2" d="M520 282.4h-3l-6.8 25.2h3z"/>
                <path class="st2" d="M510 282.4h-3l-6.8 25.2h3z"/>
                <path class="st3" d="M-499.5 300.2H500v5.1H-499.5z"/>
                <path class="st3" d="M-499.5 283.8H500v2.8H-499.5z"/>
                </g>
                <g id="cloudsAll">
